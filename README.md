...
![Colour Pallette](assets/images/readme-images/colour-palette.png)

#### Font

The font for the website is Montserrat, generated by Google Fonts. This was chosen due to being a clean contemporary font that gives the document a touch of sofistication. It is clear and easy to read without compromising on style.
